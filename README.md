...
[![License](https://img.shields.io/packagist/l/adnan/laravel-nexus.svg?style=flat-square)](LICENSE.md)
...
```php
use Adnan\LaravelNexus\Traits\Syncable;
...
protected $listen = [
    \Adnan\LaravelNexus\Events\InventoryUpdated::class => [
        PropagateInventoryToOtherChannels::class,
    ],
    \Adnan\LaravelNexus\Events\BeforeInventorySync::class => [
        EnforceSafetyStockListener::class,
    ],
    \Adnan\LaravelNexus\Events\InventorySyncFailed::class => [
        AlertOpsTeamListener::class,
    ],
    \Adnan\LaravelNexus\Events\ProductImported::class => [
